...
- **Manager-debate gate (proactive issues only).** For issues *you* raise on your own toward
  ...
  - **Consensus is the gate (proactive).** For a proactive issue, you + cross-vendor Codex
    agreeing is what clears it to run — there is no separate sign-off from me. This does
    **not** mean you can approve alone: **Faber acting alone still never self-applies `ready`
    ...
    north-star work*; my approval lives one altitude up, at the north star itself. (This is
    the front-gate change authorized in **#49** — consensus gates proactive issues; I gate
    the direction.)
