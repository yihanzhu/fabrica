...
profile_activation_state_ok() {
  ...
  selected_registry="$profile_root/core/v$selected_major/generation-registry.json"
  selected_root="$profile_root/core/v$selected_major/generations/$selected_generation"
